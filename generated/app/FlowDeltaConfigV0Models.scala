 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/delta-config/0.6.11/play_2_x_json
 */
package io.flow.delta.config.v0.models {
  ...
  object InstanceType {
     ...
     * above.
     */
    val all: scala.List[InstanceType] = scala.List(C4Large, C4Xlarge, C42xlarge, M4Large, M4Xlarge, M42xlarge, M5Large, M5Xlarge, M52xlarge, C5Large, C5Xlarge, C52xlarge, T2Micro, T2Small, T2Medium, T2Large)
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaConfigBuild: play.api.libs.json.Reads[Build] = {
      (
        ...
        (__ \ "remote_logging").read[Boolean] and
    ...
    def jsObjectBuild(obj: io.flow.delta.config.v0.models.Build): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        "remote_logging" -> play.api.libs.json.JsBoolean(obj.remoteLogging),
