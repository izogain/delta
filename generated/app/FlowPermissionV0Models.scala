 ...
 * Service version: 0.6.42
 * apibuilder 0.14.3 app.apibuilder.io/flow/permission/0.6.42/play_2_x_json
 */
package io.flow.permission.v0.models {
  ...
  final case class PermissionCheck(
    ...
    user: _root_.scala.Option[io.flow.common.v0.models.User] = None,
    roles: Seq[io.flow.permission.v0.models.FlowRole],
  ...
  object AuthenticationTechnique {
     ...
     * above.
     */
    val all: scala.List[AuthenticationTechnique] = scala.List(Anonymous, Session, Token, User)
  ...
  object FlowAddonRole {
     ...
     * organization.
     */
    case object FlowOperations extends FlowAddonRole { override def toString = "flow_operations" }
     ...
     * above.
     */
    val all: scala.List[FlowAddonRole] = scala.List(ConsumerDataViewer, MembershipManager, FlowOperations)
  ...
  object FlowUserRole {
     ...
     */
    case object PartnerOperations extends FlowUserRole { override def toString = "partner_operations" }
     ...
     * above.
     */
    val all: scala.List[FlowUserRole] = scala.List(OrganizationAdmin, OrganizationMerchant, OrganizationOperations, PartnerOperations)
  ...
  package object json {
    ...
    implicit def jsonReadsPermissionPermissionCheck: play.api.libs.json.Reads[PermissionCheck] = {
      for {
        ...
        user <- (__ \ "user").readNullable[io.flow.common.v0.models.User]
        roles <- (__ \ "roles").read[Seq[io.flow.permission.v0.models.FlowRole]]
    ...
    def jsObjectPermissionCheck(obj: io.flow.permission.v0.models.PermissionCheck): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case Some(x) => play.api.libs.json.Json.obj("user" -> io.flow.common.v0.models.json.jsObjectUser(x))
      })
    }
