 ...
 * apibuilder 0.14.3 app.apibuilder.io/flow/rollbar/0.2.1/play_2_6_client
 */
...
package io.flow.rollbar.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder 0.14.3 app.apibuilder.io/flow/rollbar/0.2.1/play_2_6_client"
    val Version = "0.2.1"
    val VersionMajor = 0
