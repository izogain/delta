 ...
 * apidoc:0.11.15 http://www.apidoc.me/flow/docker-registry/0.0.3/play_2_4_client
 */
package io.flow.docker.registry.v0.models {
  ...
  case class V2TagDetails(
    ...
    lastUpdated: String,
    lastUpdater: Long,
    imageId: _root_.scala.Option[String] = None,
    v2: Boolean
  )
  ...
  package object json {
    ...
    implicit def jsonReadsDockerRegistryV2TagDetails: play.api.libs.json.Reads[V2TagDetails] = {
      (
        ...
        (__ \ "image_id").readNullable[String] and
        (__ \ "v2").read[Boolean]
    ...
    def jsObjectV2TagDetails(obj: io.flow.docker.registry.v0.models.V2TagDetails) = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("image_id" -> play.api.libs.json.JsString(x))
      })
    }
...
package io.flow.docker.registry.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.15 http://www.apidoc.me/flow/docker-registry/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
