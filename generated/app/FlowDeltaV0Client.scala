 ...
 * apidoc:0.11.22 http://www.apidoc.me/flow/delta/0.1.22/play_2_4_client
 */
...
package io.flow.delta.v0 {
  ...
  object Bindables {
    ...
    // Enum: DockerProvider
    private[this] val enumDockerProviderNotFound = (key: String, e: Exception) => s"Unrecognized $key, should be one of ${io.flow.delta.v0.models.DockerProvider.all.mkString(", ")}"
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.22 http://www.apidoc.me/flow/delta/0.1.22/play_2_4_client"
    val Version = "0.1.22"
    val VersionMajor = 0
