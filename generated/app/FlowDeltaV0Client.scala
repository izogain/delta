 ...
 * Service version: 0.1.56
 * apidoc:0.11.25 http://www.apidoc.me/flow/delta/0.1.56/play_2_4_client
 */
package io.flow.delta.v0.models {
  ...
  case class SettingsForm(
    ...
    syncTags: _root_.scala.Option[Boolean] = None,
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaBuild: play.api.libs.json.Reads[Build] = {
      (
        ...
        (__ \ "dockerfile_path").read[String]
      )(Build.apply _)
    }
    ...
    def jsObjectBuild(obj: io.flow.delta.v0.models.Build) = {
      play.api.libs.json.Json.obj(
        ...
        "dockerfile_path" -> play.api.libs.json.JsString(obj.dockerfilePath)
      )
    }
    ...
    implicit def jsonReadsDeltaBuildForm: play.api.libs.json.Reads[BuildForm] = {
      (
    ...
    def jsObjectBuildForm(obj: io.flow.delta.v0.models.BuildForm) = {
      play.api.libs.json.Json.obj(
    ...
    implicit def jsonWritesDeltaBuildForm: play.api.libs.json.Writes[BuildForm] = {
      new play.api.libs.json.Writes[io.flow.delta.v0.models.BuildForm] {
        def writes(obj: io.flow.delta.v0.models.BuildForm) = {
    ...
    def jsObjectSettings(obj: io.flow.delta.v0.models.Settings) = {
      play.api.libs.json.Json.obj(
        ...
        "sync_tags" -> play.api.libs.json.JsBoolean(obj.syncTags),
    ...
    implicit def jsonReadsDeltaSettingsForm: play.api.libs.json.Reads[SettingsForm] = {
      (
        ...
        (__ \ "sync_tags").readNullable[Boolean] and
    ...
    def jsObjectSettingsForm(obj: io.flow.delta.v0.models.SettingsForm) = {
      ...
      (obj.syncTags match {
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("sync_tags" -> play.api.libs.json.JsBoolean(x))
      }) ++
      (obj.tagMaster match {
        case None => play.api.libs.json.Json.obj()
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.25 http://www.apidoc.me/flow/delta/0.1.56/play_2_4_client"
    val Version = "0.1.56"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object Projects extends Projects {
      ...
      override def getSettingsById(
        ...
        _executeRequest("GET", s"/projects/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}/settings", requestHeaders = requestHeaders).map {
      ...
      override def putSettingsById(
        ...
        _executeRequest("PUT", s"/projects/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}/settings", body = Some(payload), requestHeaders = requestHeaders).map {
          case r if r.status == 200 => _root_.io.flow.delta.v0.Client.parseJson("io.flow.delta.v0.models.Settings", r, _.validate[io.flow.delta.v0.models.Settings])
          case r if r.status == 401 => throw new io.flow.delta.v0.errors.UnitResponse(r.status)
          case r if r.status == 404 => throw new io.flow.delta.v0.errors.UnitResponse(r.status)
          case r => throw new io.flow.delta.v0.errors.FailedRequest(r.status, s"Unsupported response code[${r.status}]. Expected: 200, 401, 404")
