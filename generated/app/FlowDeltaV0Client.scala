 ...
 * apibuilder:0.12.20 https://app.apibuilder.io/flow/delta/0.3.90/play_2_4_client
 */
package io.flow.delta.v0.models {
   ...
   * @param project
   * @param status
   * @param name This is the full name of the application that this build represents
   * and is used to lookup information in the registry, in docker hub, in AWS, etc.
   */
  case class Build(
    id: String,
   ...
   * @param desired
   * @param last
   * @param latestImage If available, the full name of the latest image for this
   * build
   */
   ...
   * @param docker Required information to locate docker images for projects
   ...
   * @param masked
   * @param description
   * @param cleartext The cleartext token. Only available when the token is initially
   * created
   * @param id
   * @param user
   */
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.20 https://app.apibuilder.io/flow/delta/0.3.90/play_2_4_client"
    val Version = "0.3.90"
    val VersionMajor = 0
  ...
  trait Events {
     ...
     * @param type
     * @param numberMinutesSinceCreation
     * @param hasError
     * @param limit The number of records to return
     * @param offset Used to paginate. First page of results is 0.
     * @param sort
  ...
  trait Projects {
     ...
     * @param id Filter by any one of these ids
     * @param organization Filter to resolvers belongs to the organization with this
     * key
  ...
  trait Repositories {
     ...
     * @param organizationId If specified, we enable additional filtering by this
     * organization (see existing_project parameter).
     * @param existingProject Optionally filter by repositories that are either already
     * mapped to existing projects or not. Requires organization_id parameter to also
     * be specified.
     * @param limit The number of records to return
     * @param offset Used to paginate. First page of results is 0.
     */
  ...
  trait Subscriptions {
     ...
     * @param identifier Find subscriptions associated with this user identifier. Exact
     * match
  ...
  trait Users {
     ...
     * @param identifier Find user associated with this randomly generated identifier.
     * Exact match
     */
    def get(
      id: _root_.scala.Option[String] = None,
