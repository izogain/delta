 ...
 * apidoc:0.11.19 http://www.apidoc.me/flow/delta/0.0.59/play_2_4_client
 */
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apidoc:0.11.19 http://www.apidoc.me/flow/delta/0.0.59/play_2_4_client"
    val Version = "0.0.59"
    val VersionMajor = 0
  ...
  class Client(
    ...
    object DashboardBuilds extends DashboardBuilds {
      override def get(
        ...
        _executeRequest("GET", s"/dashboard_builds", queryParameters = queryParameters).map {
    ...
    object Images extends Images {
      ...
      override def getById(
        ...
        _executeRequest("GET", s"/images/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}").map {
      ...
      override def deleteById(
        ...
        _executeRequest("DELETE", s"/images/${play.utils.UriEncoding.encodePathSegment(id, "UTF-8")}").map {
          case r if r.status == 204 => ()
          case r if r.status == 401 => throw new io.flow.delta.v0.errors.UnitResponse(r.status)
          case r if r.status == 404 => throw new io.flow.delta.v0.errors.UnitResponse(r.status)
