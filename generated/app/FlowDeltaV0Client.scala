 ...
 * Service version: 0.4.68
 * apibuilder:0.12.52 https://app.apibuilder.io/flow/delta/0.4.68/play_2_4_client
 */
package io.flow.delta.v0.models {
  ...
  case class Organization(
    ...
    travis: _root_.scala.Option[io.flow.delta.v0.models.Travis] = None
  )
  ...
  package object json {
    ...
    implicit def jsonReadsDeltaOrganization: play.api.libs.json.Reads[Organization] = {
      (
        ...
        (__ \ "travis").readNullable[io.flow.delta.v0.models.Travis]
    ...
    def jsObjectOrganization(obj: io.flow.delta.v0.models.Organization): play.api.libs.json.JsObject = {
      play.api.libs.json.Json.obj(
        ...
        case None => play.api.libs.json.Json.obj()
        case Some(x) => play.api.libs.json.Json.obj("travis" -> jsObjectTravis(x))
      })
    }
...
package io.flow.delta.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.52 https://app.apibuilder.io/flow/delta/0.4.68/play_2_4_client"
    val Version = "0.4.68"
    val VersionMajor = 0
