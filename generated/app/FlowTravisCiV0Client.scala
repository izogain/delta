 ...
 * apibuilder:0.12.52 https://app.apibuilder.io/flow/travis-ci/0.0.10/play_2_4_client
 */
...
package io.flow.travis.ci.v0.models {
  ...
  package object json {
    ...
    implicit def jsonReadsTravisCiRequestConfigBranchesData: play.api.libs.json.Reads[RequestConfigBranchesData] = {
      (__ \ "only").readNullable[Seq[String]].map { x => new RequestConfigBranchesData(only = x) }
    }
...
package io.flow.travis.ci.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.52 https://app.apibuilder.io/flow/travis-ci/0.0.10/play_2_4_client"
    val Version = "0.0.10"
    val VersionMajor = 0
