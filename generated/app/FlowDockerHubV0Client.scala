 ...
 * apibuilder:0.12.3 https://api.apibuilder.io/flow/docker-hub/0.0.3/play_2_4_client
 */
...
package io.flow.docker.hub.v0 {
  ...
  object Constants {
    ...
    val UserAgent = "apibuilder:0.12.3 https://api.apibuilder.io/flow/docker-hub/0.0.3/play_2_4_client"
    val Version = "0.0.3"
    val VersionMajor = 0
