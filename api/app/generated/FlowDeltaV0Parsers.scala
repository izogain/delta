 ...
 * apibuilder:0.12.52 https://app.apibuilder.io/flow/delta/0.4.68/anorm_2_x_parsers
 */
import anorm._
...
package io.flow.delta.v0.anorm.parsers {
  ...
  object Organization {
    ...
    def parserWithPrefix(prefix: String, sep: String = "_") = parser(
      ...
      travisPrefix = s"$prefix${sep}travis"
    )
    ...
    def parser(
      ...
      SqlParser.str(id) ~
      io.flow.delta.v0.anorm.parsers.UserSummary.parserWithPrefix(userPrefix) ~
      io.flow.delta.v0.anorm.parsers.Docker.parserWithPrefix(dockerPrefix) ~
      io.flow.delta.v0.anorm.parsers.Travis.parserWithPrefix(travisPrefix).? map {
