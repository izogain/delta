 ...
 * apidoc:0.11.25 http://www.apidoc.me/flow/delta/0.1.56/anorm_2_x_parsers
 */
package io.flow.delta.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqDeltaBuildForm: Column[Seq[_root_.io.flow.delta.v0.models.BuildForm]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.BuildForm]] }
    implicit val columnToMapDeltaBuildForm: Column[Map[String, _root_.io.flow.delta.v0.models.BuildForm]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.BuildForm]] }
    ...
    implicit val columnToSeqDeltaSettings: Column[Seq[_root_.io.flow.delta.v0.models.Settings]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.Settings]] }
    implicit val columnToMapDeltaSettings: Column[Map[String, _root_.io.flow.delta.v0.models.Settings]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.Settings]] }
    implicit val columnToSeqDeltaSettingsForm: Column[Seq[_root_.io.flow.delta.v0.models.SettingsForm]] = Util.parser { _.as[Seq[_root_.io.flow.delta.v0.models.SettingsForm]] }
    implicit val columnToMapDeltaSettingsForm: Column[Map[String, _root_.io.flow.delta.v0.models.SettingsForm]] = Util.parser { _.as[Map[String, _root_.io.flow.delta.v0.models.SettingsForm]] }
