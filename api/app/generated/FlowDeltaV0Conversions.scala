 ...
 * Service version: 0.0.59
 * apidoc:0.11.19 http://www.apidoc.me/flow/delta/0.0.59/anorm_2_x_parsers
 */
package io.flow.delta.v0.anorm.conversions {
  ...
  object Json {
    ...
    implicit val columnToSeqDeltaDockerProvider: Column[Seq[_root_.io.flow.delta.v0.models.DockerProvider]] = parser { _.as[Seq[_root_.io.flow.delta.v0.models.DockerProvider]] }
    implicit val columnToMapDeltaDockerProvider: Column[Map[String, _root_.io.flow.delta.v0.models.DockerProvider]] = parser { _.as[Map[String, _root_.io.flow.delta.v0.models.DockerProvider]] }
    ...
    implicit val columnToSeqDeltaBuild: Column[Seq[_root_.io.flow.delta.v0.models.Build]] = parser { _.as[Seq[_root_.io.flow.delta.v0.models.Build]] }
    implicit val columnToMapDeltaBuild: Column[Map[String, _root_.io.flow.delta.v0.models.Build]] = parser { _.as[Map[String, _root_.io.flow.delta.v0.models.Build]] }
    implicit val columnToSeqDeltaBuildForm: Column[Seq[_root_.io.flow.delta.v0.models.BuildForm]] = parser { _.as[Seq[_root_.io.flow.delta.v0.models.BuildForm]] }
    implicit val columnToMapDeltaBuildForm: Column[Map[String, _root_.io.flow.delta.v0.models.BuildForm]] = parser { _.as[Map[String, _root_.io.flow.delta.v0.models.BuildForm]] }
    implicit val columnToSeqDeltaBuildState: Column[Seq[_root_.io.flow.delta.v0.models.BuildState]] = parser { _.as[Seq[_root_.io.flow.delta.v0.models.BuildState]] }
    implicit val columnToMapDeltaBuildState: Column[Map[String, _root_.io.flow.delta.v0.models.BuildState]] = parser { _.as[Map[String, _root_.io.flow.delta.v0.models.BuildState]] }
    implicit val columnToSeqDeltaDashboardBuild: Column[Seq[_root_.io.flow.delta.v0.models.DashboardBuild]] = parser { _.as[Seq[_root_.io.flow.delta.v0.models.DashboardBuild]] }
    implicit val columnToMapDeltaDashboardBuild: Column[Map[String, _root_.io.flow.delta.v0.models.DashboardBuild]] = parser { _.as[Map[String, _root_.io.flow.delta.v0.models.DashboardBuild]] }
    implicit val columnToSeqDeltaDocker: Column[Seq[_root_.io.flow.delta.v0.models.Docker]] = parser { _.as[Seq[_root_.io.flow.delta.v0.models.Docker]] }
    implicit val columnToMapDeltaDocker: Column[Map[String, _root_.io.flow.delta.v0.models.Docker]] = parser { _.as[Map[String, _root_.io.flow.delta.v0.models.Docker]] }
