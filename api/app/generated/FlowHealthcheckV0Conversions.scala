 ...
 */
package io.flow.healthcheck.v0.anorm.conversions {
  ...
  object Types {
    ...
    implicit val columnToSeqHealthcheckHealthcheck: Column[Seq[_root_.io.flow.healthcheck.v0.models.Healthcheck]] = Util.parser { _.as[Seq[_root_.io.flow.healthcheck.v0.models.Healthcheck]] }
    implicit val columnToMapHealthcheckHealthcheck: Column[Map[String, _root_.io.flow.healthcheck.v0.models.Healthcheck]] = Util.parser { _.as[Map[String, _root_.io.flow.healthcheck.v0.models.Healthcheck]] }
  }
